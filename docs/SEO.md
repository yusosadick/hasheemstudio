...
4. Check Enhancements: Logo/Organization and Breadcrumbs should validate. The logo is `images/brand/logo-512.png` (square, >112 px, as Google requires); favicon is a multiple of 48 px.
